...
from demandprediction.prediction.generators.border_generator_multi_step import BorderDataHandlerMultiStep
...
class BorderModelMultistep(BaseModel):
    ...
    def __init__(self, config):
        ...
        self.data_handler: Union[None, BorderDataHandlerMultiStep] = None
    ...
    def _generate_grid_model(self):
        ...
        convlstm_dense = Dense(self.prediction_horizon, activation='relu', name='Output_ConvLSTM')(convlstm_dense)
        ...
        mlp_dense_output = Reshape(
            (self.number_of_grid_rows, self.number_of_grid_columns, self.prediction_horizon),
            name='Output_Info'
        )(mlp_dense)
