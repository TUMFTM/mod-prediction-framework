...
class HistoricalAverage(BaseModel):
    def __init__(self, config, window_size=36):
        """
    ...
    def predict(self):
        ...
        self.grid_predictions = grid_data.rolling(self.window_size).mean()[self.start_date:self.stop_date]
        self.border_predictions = border_data.rolling(self.window_size).mean()[self.start_date:self.stop_date]
