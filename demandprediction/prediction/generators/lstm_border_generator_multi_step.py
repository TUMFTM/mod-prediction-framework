...
class LSTMBorderDataHandlerMultiStep:
    # noinspection PyTypeChecker
    def __init__(self, filepath, lags, prediction_horizon, batch_size, gridcells, border_orientations,
        ...
        self.total_window_size = lags + self.shift
    ...
    def make_dataset(self, lstm_data, metadata, shuffle=True):
        """
        Generate tensorflow dataset for the multi_step_border_model
        """
