...
class BorderDataHandler:
    # noinspection PyTypeChecker
    def __init__(self, filepath, lags, batch_size, number_of_rows, number_of_columns,
    ...
    def split_grid_window(self, features_lstm, features_mlp):
        ...
        labels.set_shape([None, 1, self.number_of_rows, self.number_of_columns, None])
